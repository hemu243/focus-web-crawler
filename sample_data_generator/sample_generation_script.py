...
class SampleData(object):
	...
	def generateSampleData(self, rawFolderPath, rootDestFolderPath, label, mode="w+"):
		"""
		...
		with open(labelFile, mode) as labelFilePointer:
			for filePath in files:
				labelFilePointer.write(label + " " + filePath.replace(rootDestFolderPath + "/", ""))
				labelFilePointer.write("\n")

if __name__ == "__main__":
	SampleData().generateSampleData(os.path.abspath("sample_data_generator/dataset/raw/new_homes"),
									os.path.abspath("sample_data_generator/dataset"), "NewHome")
	SampleData().generateSampleData(os.path.abspath("sample_data_generator/dataset/raw/others"),
									os.path.abspath("sample_data_generator/dataset"), "NotNewHome", "a+")